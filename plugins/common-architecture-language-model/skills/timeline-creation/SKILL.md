...
description: "This skill should be used for FINOS CALM timeline creation: This guide provides instructions for creating complete CALM architecture timeline documents that comply with the FINOS CALM v1.2 schema.."
---
