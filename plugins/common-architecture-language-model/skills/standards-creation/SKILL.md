---
name: standards-creation
description: "This skill should be used for FINOS CALM standards creation: Standards are JSON Schema 2020-12 documents that extend core CALM components with organization-specific or domain-specific properties.."
---
